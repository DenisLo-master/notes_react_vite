import React, { ComponentProps, FC, PropsWithChildren, ReactEventHandler, useEffect, useRef, useState } from "react";
            ...
            <Group position="right" spacing="xl">
                ...
                <Group pb={"1rem"} spacing="xs">
                    <>
                        ...
                        <ActionIcon
                            variant='default'
                            onClick={() => getMarkdownText("listNumber")}
                        >
                            <IconListNumbers
                                size={rem(18)} />
                        </ActionIcon>
                ...
                <Group pb={"1rem"} position="right" spacing="xs">
                    <Button
                        variant='default'
                        size="xs"
                        onClick={() => getMarkdownText("italics")}
                    >
                        K
                    </Button>
                    <Button
